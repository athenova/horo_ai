...
if __name__ == '__main__':
    ...
    schedule.every().day.at("20:02",'Europe/Moscow').do(job, type="taurus", group_id='229860740')
    schedule.every().day.at("20:03",'Europe/Moscow').do(job, type="gemini", chat_id='@gemini_the', group_id='229837895')
    schedule.every().day.at("20:04",'Europe/Moscow').do(job, type="cancer", group_id='229860780')
    schedule.every().day.at("20:05",'Europe/Moscow').do(job, type="leo", group_id='229860665')
    schedule.every().day.at("20:06",'Europe/Moscow').do(job, type="virgo", group_id='229860810')
    schedule.every().day.at("20:07",'Europe/Moscow').do(job, type="libra", group_id='229860834')
    schedule.every().day.at("20:08",'Europe/Moscow').do(job, type="scorpio", group_id='229860866')
    schedule.every().day.at("20:09",'Europe/Moscow').do(job, type="sagittarius", group_id='229860894')
